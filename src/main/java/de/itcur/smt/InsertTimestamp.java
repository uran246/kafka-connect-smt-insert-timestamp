...
public abstract class InsertTimestamp<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    public static final String OVERVIEW_DOC =
            "Insert a timestamp into a connect record";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            .define(ConfigName.TIMESTAMP_FIELD_NAME, ConfigDef.Type.STRING, "ts_field", ConfigDef.Importance.HIGH,
    ...
    public void configure(Map<String, ?> props) {
        ...
        fieldName = config.getString(ConfigName.TIMESTAMP_FIELD_NAME);
    ...
    private R applySchemaless(R record) {
        ...
        updatedValue.put(fieldName, getCurrentTimestamp());
